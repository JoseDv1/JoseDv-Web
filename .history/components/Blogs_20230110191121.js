...
export function Blogs() {
  ...
  const [blogEditStatus, setBlogEditStatus] = useState(blogEditSTATES.NONE);
  ...
  const handleEdit = (id, newBLog) => {
    ...
    if (title.value && content.value) {
      updateDocInCollection("blogs", id, newBLog);
      getDocsFromCollection("blogs").then((docs) => setBlogs(docs));
      setBlogEditStatus(blogEditSTATES.SUCCESS);
    } else {
      setBlogPostStatus(blogPostSTATES.FAILED);
    }
  };
      ...
      <section id="PostBlog">
        ...
        <div className="message">
          ...
          {blogPostStatus == blogPostSTATES.FAILED ||
            (blogEditStatus == blogEditSTATES.FAILED && (
