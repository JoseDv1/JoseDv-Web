...
export function Blogs() {
  ...
  const [blogIdStatus, setBlogIdStatus] = useState(blogPostSTATES.NONE);
  ...
  const handlePostForm = (e) => {
    ...
    if (title.value && content.value) {
      ...
      title.value = "";
      content.value = "";
      setBlogIdStatus(blogPostSTATES.SUCCESS);
    } else {
      setBlogIdStatus(blogPostSTATES.FAILED);
    }
  };
    ...
    <>
      <section id="PostBlog">
        ...
        <div className="message">
          {blogIdStatus == blogPostSTATES.SUCCESS && (
            <div className="PostSuccess">
              <p>Blog posted successfully with id: {blogId}</p>
            </div>
          )}

          {blogIdStatus == blogPostSTATES.FAILED && (
