...
export function Blogs() {
  ...
  const [blogIdStatus, setBlogIdStatus] = useState(blogSTATES.NONE);
  ...
  const handlePostForm = (e) => {
    ...
    if (title.value && content.value) {
      ...
      title.value = "";
      content.value = "";
      setBlogIdStatus(blogSTATES.SUCCESS);
    } else {
      setBlogIdStatus(blogSTATES.FAILED);
    }
  };
